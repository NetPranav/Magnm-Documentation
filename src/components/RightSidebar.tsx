    ...
    <div className="flex flex-col h-full">
      ...
      {!isProjectMode && (
        <div className="mt-auto pt-8 border-t border-border mb-4">
          <Link 
            href="/project-mode" 
            className="group relative flex items-center justify-center w-full px-4 py-2.5 rounded-xl font-medium overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(var(--primary-rgb),0.5)]"
          >
            {/* Background gradient */}
            <div className="absolute inset-0 bg-gradient-to-r from-primary to-primary-light opacity-90 transition-opacity duration-300 group-hover:opacity-100" />
            ...
            <div className="relative z-10 flex items-center text-white">
              ...
              <span className="tracking-wide">Learn By Project</span>
            </div>
          </Link>
        </div>
      )}
